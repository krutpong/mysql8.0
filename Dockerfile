...
# Set repositories
RUN \
  echo "deb http://mirror.kku.ac.th/debian/ stretch main non-free contrib" > /etc/apt/sources.list && \
  echo "deb-src http://mirror.kku.ac.th/debian/ stretch main non-free contrib" >> /etc/apt/sources.list && \
